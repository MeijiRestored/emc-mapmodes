...
let colors = [
  ...
  {
    name: "Greater Roman Empire",
    nations: ["SPQR", "Italia", "Romania", "Greater_Romania"],
    color: ["#B200FF"],
  },
  {
    name: "Spanish Empire",
  ...
  {
    name: "Caucasus Empire",
    nations: ["Greater-Armenia", "Sakartvelo"],
    color: ["#A5FF7F"],
  },
  {
    name: "Second Finnish Empire",
    nations: ["Lapland", "Suomi", "Tavastia"],
    color: ["#93D2FF"],
  },
  {
    name: "Estonian Empire",
    nations: ["Estonia", "Finnmark", "Kievan_Rus"],
    color: ["#5FBFBF"],
  },
  ...
  {
    name: "Israel",
    nations: ["Israel", "Himyar", "Qatar", "Europe", "Egypt"],
    color: ["#0038B8"],
  },
  {
  ...
  {
    name: "Federation of the East",
    nations: ["Philippines", "McMurdo", "Mindanao", "Mozambique"],
    color: ["#0038A8"],
  },
  {
    name: "Indochina",
    nations: ["Indochina", "Sumatra", "Vietnam"],
    color: ["#FFFFFF"],
  },
  {
    name: "Majapahit Empire",
    nations: ["Majapahit", "Dutch_Indies", "Sulawesi", "Sarawak", "Maluku"],
    color: ["#FFDF3F"],
  },
  { name: "Taiwan", nations: ["Taiwan", "Takasago"], color: ["#7FFFFF"] },

  {
    name: "Oniyama Shogunate",
    nations: [
      "Grasberg",
      "Pulau_Japen",
      "Lützow-holm_bay",
  ...
  {
    name: "New_Zealand",
    nations: ["New_Zealand", "South_Island"],
    color: ["#F5281C"],
  },

  {
    name: "Second Nubian Empire",
    nations: [
      "Nubia",
      "Kasai",
      "Nejd",
  ...
  {
    name: "Federation of the Indian Ocean",
    nations: [
      "Ancient_Egypt",
      "Somalia",
      "Congo_FreeState",
...

  {
    ...
    nations: ["Brazil", "Peru-Bolivia", "Manabi"],
    color: ["#009F3A"],
  },

  {
    name: "Theocratic Confederacy of Antarctica",
    nations: [
      "SSRBV",
      "Amery",
      "Antarctic_Empire",
  ...
  {
    name: "Egalitarist People's Republic of Antarctica",
    nations: ["Casey", "Sandwich_Islands", "Marie_Byrd_Land", "Antarctica"],
    color: ["#FED700"],
  },
  ...
  {
    name: "Republic of Rio Grande",
    nations: ["Rio_Grande", "Lone_Star", "New_Mexico"],
    color: ["#000000"],
  },
  {
    name: "Texico Empire",
    nations: ["Texas_Republic", "Pueblo", "Zapotec"],
    color: ["#002868"],
  },
  {
    name: "State of Jefferson",
    nations: [
      "Jefferson",
      "RoughAndReady",
      "Utah",
  ...
  {
    name: "Salish Confederation",
    nations: ["Canadian_Rockies", "British_Columbia", "Nez_Perce", "Keewatin"],
    color: ["#FFFFFF"],
  },
  {
    name: "Columbian Empire",
    nations: ["Columbia", "Sahtu", "October_Island"],
    color: ["#0000CC"],
  },
  {
    name: "Alaskan Tsardom",
    nations: ["Kodiak", "Anchorage", "Bering_Strait", "Yukon"],
    color: ["#011DC1"],
  },
  {
    name: "Republic of Cascadia",
    nations: [
      "Bhutan",
      "Cascadia",
      "Colorado",
  ...
  {
    name: "Grand Maritime Federation",
    nations: [
      "Woodland_Cree",
      "Angola",
      "Bermuda",
